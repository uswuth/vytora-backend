...
type ComplianceRecordHandler struct {
	compRepo   *repository.ComplianceRecordRepository
	vendorRepo *repository.VendorRepository
	seqService *services.SequenceService
	validate   *validator.Validate
}

func NewComplianceRecordHandler(
	compRepo *repository.ComplianceRecordRepository,
	vendorRepo *repository.VendorRepository,
	seqService *services.SequenceService,
) *ComplianceRecordHandler {
	return &ComplianceRecordHandler{
		compRepo:   compRepo,
...
func (h *ComplianceRecordHandler) Create(w http.ResponseWriter, r *http.Request) {
	...
	code, err := h.seqService.NextCode(r.Context(), "compliance_record")
	if err != nil {
...
func (h *ComplianceRecordHandler) Get(w http.ResponseWriter, r *http.Request) {
...
func (h *ComplianceRecordHandler) Update(w http.ResponseWriter, r *http.Request) {
	code := chi.URLParam(r, "code")
...
func (h *ComplianceRecordHandler) List(w http.ResponseWriter, r *http.Request) {
...
func (h *ComplianceRecordHandler) Expiring(w http.ResponseWriter, r *http.Request) {
